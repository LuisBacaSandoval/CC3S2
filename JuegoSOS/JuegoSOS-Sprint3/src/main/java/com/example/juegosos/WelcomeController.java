...
public class WelcomeController {
    ...
    public void onButtonClickNextWindow() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("tableSelector-view.fxml"));
        Parent root = fxmlLoader.load();
        TableSelectorController tableSelectorController = fxmlLoader.getController();
