...
public class TableController{
    ...
    public void navigateToNextWindow(ActionEvent actionEvent) throws IOException {
        if(Tablero.getNroRow() == 3 && Tablero.getNroColumn() == 3 && Tablero.getModeGame()=="Simple"){
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("tableSOSGeneral-view.fxml"));
            Parent root = fxmlLoader.load();
            TableSOSGeneralController tableSOSGeneralController = fxmlLoader.getController();
